...
if page == "Home":
    ...
    with col1:
        st.image("profile.jpg", width=500)
    with col2:
        st.markdown("""
...
# -------------------------------
    ...
    categories = ["ML", "Python", "Data Analysis", "Causal inference", "Projects"]
    values = [5,5,4,4,3]
    fig = go.Figure()
